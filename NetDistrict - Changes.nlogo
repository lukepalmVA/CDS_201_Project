...
to color-blocks ;; color each block according to partisan score
  ...
  ask blocks [
    ifelse partisan-score > .5 [ set color scale-color blue partisan-score 1.5 .5 ] [ set color scale-color red partisan-score -.5 .5 ] ]
end
